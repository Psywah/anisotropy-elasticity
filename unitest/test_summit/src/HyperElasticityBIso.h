...
class hyperelasticitybiso_coordinate_mapping_3: public ufc::coordinate_mapping
{
public:

  hyperelasticitybiso_coordinate_mapping_3();

  ~hyperelasticitybiso_coordinate_mapping_3() override;
