...
class p1vectorelement_coordinate_mapping_1: public ufc::coordinate_mapping
{
public:

  p1vectorelement_coordinate_mapping_1();

  ~p1vectorelement_coordinate_mapping_1() override;
